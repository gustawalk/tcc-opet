...
- O banco usa SQLCipher e os anexos usam criptografia autenticada. A proteção evita a visualização casual de arquivos locais, mas não protege contra quem consegue executar ou analisar o aplicativo instalado.
