...
export function GlobalSearch() {
  ...
  return <>
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}><DialogContent className="top-4 max-w-xl translate-y-0"><DialogHeader><DialogTitle>Busca global</DialogTitle></DialogHeader><Input autoFocus value={term} onChange={(event) => setTerm(event.target.value)} placeholder="Buscar clientes, OS, estoque ou modelos..." />
